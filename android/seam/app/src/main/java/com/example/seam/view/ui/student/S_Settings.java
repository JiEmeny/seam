...
import com.example.seam.view.ui.root.About;
 ...
 */
public class S_Settings extends NetworkActivity<SettingsBinding> {
    @Override
    ...
    protected void onObserveData() {
        ...
        binding.logout.setOnClickListener(v -> {
            ...
            edit.clear();
            edit.commit();
            startActivity(new Intent(S_Settings.this, Login.class));
        });
        // 关于软件
        binding.about.setOnClickListener(v -> {
            startActivity(new Intent(S_Settings.this, About.class));
        });
    }
}
