 ...
 */
public class Teacher_Check extends Fragment {

    private com.example.seam.databinding.RootCheckBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = com.example.seam.databinding.RootCheckBinding.inflate(LayoutInflater.from(container.getContext()), container, false);
