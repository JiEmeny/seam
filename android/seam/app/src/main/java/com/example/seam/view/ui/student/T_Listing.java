 ...
 */
public class T_Listing extends NetworkActivity<TListingBinding> {
    ...
    private void RV(Map<String, String> map, List<Register.RowsBean> rows) {
        AdapterTListing adapterRootCheck = new AdapterTListing(map, rows, this);
