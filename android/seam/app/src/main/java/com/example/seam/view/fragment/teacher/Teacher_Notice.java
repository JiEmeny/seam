...
import com.example.seam.databinding.TNoticeBinding;
...
import com.example.seam.view.ui.student.S_NoticeDatails;
 ...
 */
public class Teacher_Notice extends Fragment {
    private TNoticeBinding binding;
    private RootNoticeVM model;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = TNoticeBinding.inflate(LayoutInflater.from(container.getContext()), container, false);
        ...
        model.noticeMutableLiveData.observe(getViewLifecycleOwner(), notice -> {
            ...
            adapterRootNotice.click(new onClick() {
                ...
                public void Click(int posotopn) {
                    Intent intent = new Intent(getContext(), S_NoticeDatails.class);
