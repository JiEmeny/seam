...
import com.example.seam.view.ui.root.DetailedInformation;
import com.example.seam.view.ui.root.FeedBack;
import com.example.seam.view.ui.root.Settings;
 ...
 */
public class Root_Personal extends Fragment {
    ...
    private void JumpUI() {
        ...
        binding.constraintLayout.setOnClickListener(v -> {
            startActivity(new Intent(getContext(), DetailedInformation.class));
        });
    }
