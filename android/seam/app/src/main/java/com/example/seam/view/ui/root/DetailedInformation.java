...
import com.example.seam.databinding.DetailedinformationBinding;
 ...
 */
public class DetailedInformation extends NetworkActivity<DetailedinformationBinding> {
            ...
            if (u.getRows().size() > 0) {
                ...
                model.usersMutableLiveData.observe(this, users -> {
                    ...
                    if (usersRows.size() > 0) {
                        ...
                        Glide.with(DetailedInformation.this)
    ...
    private void Jump() {
        ...
        binding.cons2.setOnClickListener(v -> {
            Intent intent = new Intent(DetailedInformation.this, Modify.class);
        ...
        if (requestCode == 0 && data != null) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (this != null || uri != null) {
                    ...
                    DocumentFile documentFile = DocumentFile.fromSingleUri(DetailedInformation.this, uri);
